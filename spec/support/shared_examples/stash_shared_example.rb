shared_examples 'an acceptable Stash instance' do |database_examples|
  ...
  describe 'Going through the setup process' do
    ...
    context 'when processing license setup' do
      ...
      it { is_expected.to have_button 'Go to Stash' }
    end
    ...
    context 'when processing administrative account setup' do
      before :all do
        ...
        fill_in 'email', with: 'stash@circleci.com'
        fill_in 'password', with: 'admin'
        fill_in 'confirmPassword', with: 'admin'
        click_button 'Go to Stash'
        wait_for_page
      end
    ...
    context 'when logging in' do
      ...
      # Stash dashboard without any trouble through the setup.
    end
  end
